...
-- Copiando dados para a tabela mdg_ultimate.container: ~70 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=1717 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;

-- Copiando dados para a tabela mdg_ultimate.items: ~1.076 rows (aproximadamente)
