...
-- Copiando estrutura para tabela mdg_ultimate.barcos
CREATE TABLE IF NOT EXISTS `barcos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `identifier` varchar(50) NOT NULL,
  `charid` int(11) NOT NULL,
  `model` varchar(50) NOT NULL,
  `name` varchar(50) NOT NULL DEFAULT 'Boat',
...
-- Copiando dados para a tabela mdg_ultimate.barcos: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela mdg_ultimate.container: ~71 rows (aproximadamente)
...
-- Copiando estrutura para tabela mdg_ultimate.farming
...
-- Copiando dados para a tabela mdg_ultimate.farming: ~0 rows (aproximadamente)
...
-- Copiando estrutura para tabela mdg_ultimate.horse_breeding_pending
CREATE TABLE IF NOT EXISTS `horse_breeding_pending` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `mother_id` int(11) NOT NULL,
  `father_id` int(11) NOT NULL,
  `owner_identifier` varchar(64) NOT NULL,
  `owner_charid` int(11) NOT NULL,
  `stable` varchar(64) DEFAULT NULL,
  `date_start` bigint(20) NOT NULL,
  `foal_data` longtext NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_mother` (`mother_id`),
  KEY `idx_owner` (`owner_identifier`,`owner_charid`),
  KEY `father_id` (`father_id`),
  CONSTRAINT `horse_breeding_pending_ibfk_1` FOREIGN KEY (`mother_id`) REFERENCES `mdg_horses` (`id`) ON DELETE CASCADE,
  CONSTRAINT `horse_breeding_pending_ibfk_2` FOREIGN KEY (`father_id`) REFERENCES `mdg_horses` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- Copiando dados para a tabela mdg_ultimate.horse_breeding_pending: ~0 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=1920 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;

-- Copiando dados para a tabela mdg_ultimate.items: ~1.087 rows (aproximadamente)
INSERT IGNORE INTO `items` (`item`, `label`, `limit`, `can_remove`, `type`, `usable`, `id`, `groupId`, `metadata`, `desc`, `weight`, `degradation`) VALUES
	...
	('agua_purificada', 'Agua Purificada', 999, 1, 'item_standard', 1, 1741, 1, '{}', 'Agua fervida na fogueira ate ficar limpa. Mata a sede sem risco de doenca.', 0.01, 0),
	('agua_suja', 'Agua Suja', 100, 1, 'item_standard', 1, 721, 1, '{}', 'nice item', 0.50, 0),
	('agulha_costura', 'Agulha de Costura', 999, 1, 'item_standard', 1, 1745, 1, '{}', 'Agulha de Costura.', 0.01, 0),
	...
	('artesanato_annesburg', 'Livro Artesanato Annesburg', 999, 1, 'item_standard', 1, 1746, 1, '{}', 'Livro Artesanato Annesburg.', 0.01, 0),
	...
	('bacon', 'Bacon', 999, 1, 'item_standard', 1, 1747, 1, '{}', 'Bacon.', 0.01, 0),
	...
	('bando_01', 'bando_01', 100, 1, 'item_standard', 1, 1722, 1, '{}', 'nice item', 0.25, 0),
	('bando_02', 'bando_02', 100, 1, 'item_standard', 1, 1723, 1, '{}', 'nice item', 0.25, 0),
	('bando_03', 'bando_03', 100, 1, 'item_standard', 1, 1724, 1, '{}', 'nice item', 0.25, 0),
	('bando_04', 'bando_04', 100, 1, 'item_standard', 1, 1725, 1, '{}', 'nice item', 0.25, 0),
	('bando_05', 'bando_05', 100, 1, 'item_standard', 1, 1726, 1, '{}', 'nice item', 0.25, 0),
	...
	('beerbox', 'Beer Box', 20, 1, 'item_standard', 1, 1829, 1, '{}', 'nice item', 0.25, 0),
	...
	('biscoito', 'Biscoito', 999, 1, 'item_standard', 1, 1748, 1, '{}', 'Biscoito.', 0.01, 0),
	('bituca', 'Bituca de cigarro', 100, 1, 'item_standard', 1, 1667, 1, '{}', 'Bituca', 0.50, 0),
	...
	('bolo', 'Bolo', 999, 1, 'item_standard', 1, 1749, 1, '{}', 'Bolo.', 0.01, 0),
	...
	('butchertable1', 'Small Butcher Table', 20, 1, 'item_standard', 1, 1826, 1, '{}', 'nice item', 0.25, 0),
	('butchertable2', 'Medium Butcher Table', 20, 1, 'item_standard', 1, 1828, 1, '{}', 'nice item', 0.25, 0),
	('butchertable3', 'Large Butcher Table', 20, 1, 'item_standard', 1, 1824, 1, '{}', 'nice item', 0.25, 0),
	...
	('cano_arma', 'Cano de Arma', 999, 1, 'item_standard', 1, 1750, 1, '{}', 'Cano de Arma.', 0.01, 0),
	...
	('carta', 'Carta', 100, 1, 'item_standard', 1, 1721, 1, '{}', 'nice item', 0.25, 0),
	...
	('certificado_mineracao', 'Certificado de Mineração', 100, 1, 'item_standard', 1, 1659, 1, '{}', 'nice item', 0.25, 0),
	('certificado_pesca', 'Certificado de Pesca', 1, 1, 'item_standard', 1, 1658, 1, '{}', 'nice item', 0.25, 0),
	('cerveja', 'Cerveja', 999, 1, 'item_standard', 1, 1751, 1, '{}', 'Cerveja.', 0.01, 0),
	...
	('charque', 'Charque', 999, 1, 'item_standard', 1, 1752, 1, '{}', 'Charque.', 0.01, 0),
	...
	('chewingtobacco2', 'Tabaco de Mascar', 100, 1, 'item_standard', 1, 1686, 1, '{}', 'nice item', 0.50, 0),
	('chewingtobacco3', 'Tabaco de Mascar', 100, 1, 'item_standard', 1, 1687, 1, '{}', 'nice item', 0.50, 0),
	('chewingtobacco4', 'Tabaco de Mascar', 100, 1, 'item_standard', 1, 1688, 1, '{}', 'nice item', 0.50, 0),
	('chewingtobacco5', 'Tabaco de Mascar', 100, 1, 'item_standard', 1, 1689, 1, '{}', 'nice item', 0.50, 0),
	('chifre', 'Chifre', 100, 1, 'item_standard', 1, 864, 1, '{}', 'nice item', 0.80, 0),
	('chope', 'Chope', 999, 1, 'item_standard', 1, 1753, 1, '{}', 'Chope.', 0.01, 0),
	('cigar', 'Cigarro', 100, 1, 'item_standard', 1, 1714, 1, '{}', 'nice item', 0.25, 0),
	('cigarcard1', 'Carteira de Cigarro 10uni', 100, 1, 'item_standard', 1, 1670, 1, '{}', 'Carteira com 10 cigarros', 0.50, 0),
	('cigarcard2', 'Carteira de Cigarro 5uni', 100, 1, 'item_standard', 1, 1671, 1, '{}', 'Carteira com 5 cigarros', 0.50, 0),
	('cigarcard3', 'Carteira de Cigarro Vazia', 100, 1, 'item_standard', 1, 1672, 1, '{}', 'Carteira vazia', 0.50, 0),
	('cigaret', 'Maço de cigarros', 100, 1, 'item_standard', 1, 1673, 1, '{}', 'Maço novo', 0.50, 0),
	('cigaret10', 'Maço de cigarros', 100, 1, 'item_standard', 1, 1684, 1, '{}', 'Resta 1 cigarro', 0.50, 0),
	('cigaret2', 'Maço de cigarros', 100, 1, 'item_standard', 1, 1676, 1, '{}', 'Restam 9 cigarros', 0.50, 0),
	('cigaret3', 'Maço de cigarros', 100, 1, 'item_standard', 1, 1677, 1, '{}', 'Restam 8 cigarros', 0.50, 0),
	('cigaret4', 'Maço de cigarros', 100, 1, 'item_standard', 1, 1678, 1, '{}', 'Restam 7 cigarros', 0.50, 0),
	('cigaret5', 'Maço de cigarros', 100, 1, 'item_standard', 1, 1679, 1, '{}', 'Restam 6 cigarros', 0.50, 0),
	('cigaret6', 'Maço de cigarros', 100, 1, 'item_standard', 1, 1680, 1, '{}', 'Restam 5 cigarros', 0.50, 0),
	('cigaret7', 'Maço de cigarros', 100, 1, 'item_standard', 1, 1681, 1, '{}', 'Restam 4 cigarros', 0.50, 0),
	('cigaret8', 'Maço de cigarros', 100, 1, 'item_standard', 1, 1682, 1, '{}', 'Restam 3 cigarros', 0.50, 0),
	('cigaret9', 'Maço de cigarros', 100, 1, 'item_standard', 1, 1683, 1, '{}', 'Restam 2 cigarros', 0.50, 0),
	('cigarette', 'Cigarro', 100, 1, 'item_standard', 1, 1715, 1, '{}', 'nice item', 0.25, 0),
	...
	('cocaina', 'Cocaina', 999, 1, 'item_standard', 1, 1754, 1, '{}', 'Cocaina.', 0.01, 0),
	('coffindecor', 'Coffin Decor', 20, 1, 'item_standard', 1, 1873, 1, '{}', 'nice item', 0.25, 0),
	...
	('colar_pena', 'Colar de Penas', 999, 1, 'item_standard', 1, 1735, 1, '{}', 'Colar de penas trancadas em couro, tirado de um tumulo antigo.', 0.01, 0),
	...
	('compota_frutas', 'Compota de Frutas', 999, 1, 'item_standard', 1, 1755, 1, '{}', 'Compota de Frutas.', 0.01, 0),
	...
	('couro_curtido', 'Couro Curtido', 999, 1, 'item_standard', 1, 1756, 1, '{}', 'Couro Curtido.', 0.01, 0),
	('couro_macio', 'Couro Macio', 999, 1, 'item_standard', 1, 1757, 1, '{}', 'Couro Macio.', 0.01, 0),
	('coyote_pelt', 'Coyote Pelt', 20, 1, 'item_standard', 1, 1875, 1, '{}', 'nice item', 0.25, 0),
	...
	('cuca', 'Cuca', 999, 1, 'item_standard', 1, 1758, 1, '{}', 'Cuca.', 0.01, 0),
	...
	('decoracao_nativa_a_prop', 'Decoração Nativa 1', 100, 1, 'item_standard', 1, 748, 1, '{}', 'nice item', 1.50, 0),
	('decortent1', 'Decor Tent 1 Set', 20, 1, 'item_standard', 1, 1845, 1, '{}', 'nice item', 0.25, 0),
	('decortent2', 'Decor Tent 2 Set', 20, 1, 'item_standard', 1, 1846, 1, '{}', 'nice item', 0.25, 0),
	('decortent3', 'Decor Tent 3 Set', 20, 1, 'item_standard', 1, 1847, 1, '{}', 'nice item', 0.25, 0),
	('deernativetent', 'Tenda Nativa de Pele de Veado', 10, 1, 'item_standard', 1, 966, 1, '{}', 'nice item', 13.00, 0),
	('deer_pelt', 'Deer Pelt', 20, 1, 'item_standard', 1, 1874, 1, '{}', 'nice item', 0.25, 0),
	...
	('detonador', 'Detonador', 999, 1, 'item_standard', 1, 1731, 1, '{}', 'Caixa de embolo ligada a carga por um rolo de fio. Necessaria para detonar a dinamite a distancia.', 0.01, 0),
	...
	('documento_posse_cavalo', 'Documento Cavalo', 100, 1, 'item_standard', 1, 1727, 1, '{}', 'nice item', 0.25, 0),
	...
	('enxofre', 'Enxofre', 999, 1, 'item_standard', 1, 1732, 1, '{}', 'Pedra amarela quebradica tirada da mina. Junto com salitre e carvao, vira polvora.', 0.01, 0),
	('ervaamarga', 'Erva amarga', 100, 1, 'item_standard', 1, 537, 1, '{}', 'nice item', 0.50, 0),
	('escova_engraxate', 'Escova de Engraxate', 999, 1, 'item_standard', 1, 1734, 1, '{}', 'Escova de crina para dar brilho no couro. Ferramenta do engraxate, nao se gasta.', 0.01, 0),
	...
	('fazenda_03', 'Livro Fazenda 03', 999, 1, 'item_standard', 1, 1759, 1, '{}', 'Livro Fazenda 03.', 0.01, 0),
	('fazenda_04', 'Livro Fazenda 04', 999, 1, 'item_standard', 1, 1760, 1, '{}', 'Livro Fazenda 04.', 0.01, 0),
	('fazenda_05', 'Livro Fazenda 05', 999, 1, 'item_standard', 1, 1761, 1, '{}', 'Livro Fazenda 05.', 0.01, 0),
	('fazenda_06', 'Livro Fazenda 06', 999, 1, 'item_standard', 1, 1762, 1, '{}', 'Livro Fazenda 06.', 0.01, 0),
	('fazenda_07', 'Livro Fazenda 07', 999, 1, 'item_standard', 1, 1763, 1, '{}', 'Livro Fazenda 07.', 0.01, 0),
	('fazenda_08', 'Livro Fazenda 08', 999, 1, 'item_standard', 1, 1764, 1, '{}', 'Livro Fazenda 08.', 0.01, 0),
	('fazenda_09', 'Livro Fazenda 09', 999, 1, 'item_standard', 1, 1765, 1, '{}', 'Livro Fazenda 09.', 0.01, 0),
	('fazenda_10', 'Livro Fazenda 10', 999, 1, 'item_standard', 1, 1766, 1, '{}', 'Livro Fazenda 10.', 0.01, 0),
	('fazenda_11', 'Livro Fazenda 11', 999, 1, 'item_standard', 1, 1767, 1, '{}', 'Livro Fazenda 11.', 0.01, 0),
	('fazenda_12', 'Livro Fazenda 12', 999, 1, 'item_standard', 1, 1768, 1, '{}', 'Livro Fazenda 12.', 0.01, 0),
	('fazenda_13', 'Livro Fazenda 13', 999, 1, 'item_standard', 1, 1769, 1, '{}', 'Livro Fazenda 13.', 0.01, 0),
	('fazenda_14', 'Livro Fazenda 14', 999, 1, 'item_standard', 1, 1770, 1, '{}', 'Livro Fazenda 14.', 0.01, 0),
	('fazenda_15', 'Livro Fazenda 15', 999, 1, 'item_standard', 1, 1771, 1, '{}', 'Livro Fazenda 15.', 0.01, 0),
	('fazenda_16', 'Livro Fazenda 16', 999, 1, 'item_standard', 1, 1772, 1, '{}', 'Livro Fazenda 16.', 0.01, 0),
	('fazenda_17', 'Livro Fazenda 17', 999, 1, 'item_standard', 1, 1773, 1, '{}', 'Livro Fazenda 17.', 0.01, 0),
	('fazenda_18', 'Livro Fazenda 18', 999, 1, 'item_standard', 1, 1774, 1, '{}', 'Livro Fazenda 18.', 0.01, 0),
	('fazenda_19', 'Livro Fazenda 19', 999, 1, 'item_standard', 1, 1775, 1, '{}', 'Livro Fazenda 19.', 0.01, 0),
	('fazenda_20', 'Livro Fazenda 20', 999, 1, 'item_standard', 1, 1776, 1, '{}', 'Livro Fazenda 20.', 0.01, 0),
	('fazenda_21', 'Livro Fazenda 21', 999, 1, 'item_standard', 1, 1777, 1, '{}', 'Livro Fazenda 21.', 0.01, 0),
	('fazenda_22', 'Livro Fazenda 22', 999, 1, 'item_standard', 1, 1778, 1, '{}', 'Livro Fazenda 22.', 0.01, 0),
	('fazenda_23', 'Livro Fazenda 23', 999, 1, 'item_standard', 1, 1779, 1, '{}', 'Livro Fazenda 23.', 0.01, 0),
	('fazenda_24', 'Livro Fazenda 24', 999, 1, 'item_standard', 1, 1780, 1, '{}', 'Livro Fazenda 24.', 0.01, 0),
	('fazenda_25', 'Livro Fazenda 25', 999, 1, 'item_standard', 1, 1781, 1, '{}', 'Livro Fazenda 25.', 0.01, 0),
	('fazenda_26', 'Livro Fazenda 26', 999, 1, 'item_standard', 1, 1782, 1, '{}', 'Livro Fazenda 26.', 0.01, 0),
	...
	('flag', 'Camp Flag', 20, 1, 'item_standard', 1, 1827, 1, '{}', 'nice item', 0.25, 0),
	...
	('florzinha', 'Flor', 100, 1, 'item_standard', 1, 1675, 1, '{}', 'Uma flor', 0.50, 0),
	...
	('fosforos', 'Fósforo', 100, 1, 'item_standard', 1, 1666, 1, '{}', 'Fogo', 0.50, 0),
	('framboesa', 'Framboesa', 100, 1, 'item_standard', 1, 567, 1, '{}', 'nice item', 0.50, 0),
	('fumo_corda', 'Fumo de Corda', 999, 1, 'item_standard', 1, 1783, 1, '{}', 'Fumo de Corda.', 0.01, 0),
	...
	('garrafa_vazia', 'Garrafa Vazia', 999, 1, 'item_standard', 1, 1917, 1, '{}', 'Garrafa de vidro vazia.', 0.01, 0),
	('garra_urso', 'Garra de Urso', 100, 1, 'item_standard', 1, 866, 1, '{}', 'nice item', 0.30, 0),
	('gatilho', 'Gatilho', 999, 1, 'item_standard', 1, 1784, 1, '{}', 'Gatilho.', 0.01, 0),
	('geleia_frutas', 'Geleia de Frutas', 999, 1, 'item_standard', 1, 1785, 1, '{}', 'Geleia de Frutas.', 0.01, 0),
	...
	('graxa', 'Graxa', 999, 1, 'item_standard', 1, 1733, 1, '{}', 'Lata de graxa preta para lustrar botas. Gasta um pouco a cada cliente atendido.', 0.01, 0),
	...
	('guitarra_001', 'Guitarra 1', 100, 1, 'item_standard', 1, 1717, 1, '{}', 'nice item', 0.25, 0),
	('guitarra_002', 'Guitarra 2', 100, 1, 'item_standard', 1, 1718, 1, '{}', 'nice item', 0.25, 0),
	('guitarra_003', 'Guitarra 3', 100, 1, 'item_standard', 1, 1719, 1, '{}', 'nice item', 0.25, 0),
	('guitarra_004', 'Guitarra 4', 100, 1, 'item_standard', 1, 1720, 1, '{}', 'nice item', 0.25, 0),
	('gun_barrel', 'Cano da arma', 10, 1, 'item_standard', 1, 896, 1, '{}', 'nice item', 2.00, 0),
	('gypsywagon', 'Gypsys Wagon Set', 20, 1, 'item_standard', 1, 1830, 1, '{}', 'nice item', 0.25, 0),
	...
	('hemp', 'Hemp', 20, 1, 'item_standard', 1, 1861, 1, '{}', 'nice item', 0.25, 0),
	('hemp_seed', 'Hemp Seed', 20, 1, 'item_standard', 1, 1860, 1, '{}', 'nice item', 0.25, 0),
	('hitchingpost', 'Hitching Post', 20, 1, 'item_standard', 1, 1825, 1, '{}', 'nice item', 0.25, 0),
	('horsehitches', 'Horse Hitches Set', 20, 1, 'item_standard', 1, 1848, 1, '{}', 'nice item', 0.25, 0),
	...
	('iogurte', 'Iogurte', 999, 1, 'item_standard', 1, 1786, 1, '{}', 'Iogurte.', 0.01, 0),
	('isca_herbivore', 'Isca para Herbivoro', 999, 1, 'item_standard', 1, 1787, 1, '{}', 'Isca para Herbivoro.', 0.01, 0),
	('isca_herbivore_potente', 'Isca Potente para Herbivoro', 999, 1, 'item_standard', 1, 1788, 1, '{}', 'Isca Potente para Herbivoro.', 0.01, 0),
	('isca_predator', 'Isca para Predador', 999, 1, 'item_standard', 1, 1789, 1, '{}', 'Isca para Predador.', 0.01, 0),
	('isca_predator_potente', 'Isca Potente para Predador', 999, 1, 'item_standard', 1, 1790, 1, '{}', 'Isca Potente para Predador.', 0.01, 0),
	...
	('jornal_entrega', 'Jornal para Entrega', 999, 1, 'item_standard', 1, 1913, 1, '{}', 'Maco de jornais do dia, pronto para a entrega.', 0.01, 0),
	...
	('lamppost1', 'Lamp Post 1 Set', 20, 1, 'item_standard', 1, 1851, 1, '{}', 'nice item', 0.25, 0),
	('lamppost2', 'Lamp Post 2 Set', 20, 1, 'item_standard', 1, 1852, 1, '{}', 'nice item', 0.25, 0),
	...
	('lingote_aco', 'Lingote de Aco', 999, 1, 'item_standard', 1, 1791, 1, '{}', 'Lingote de Aco.', 0.01, 0),
	...
	('linguica', 'Linguica', 999, 1, 'item_standard', 1, 1792, 1, '{}', 'Linguica.', 0.01, 0),
	('linha', 'Linha', 100, 1, 'item_standard', 1, 1091, 1, '{}', 'nice item', 0.50, 0),
	('livro_arquivos', 'Livro de Arquivos', 999, 1, 'item_standard', 1, 1738, 1, '{}', 'Livro de capa de couro com as condenacoes do condado. Abre o dossie de prisao.', 0.01, 0),
	...
	('livro_devedores', 'Livro de Devedores', 999, 1, 'item_standard', 1, 1739, 1, '{}', 'Caderno de capa dura onde a empresa anota quem ficou devendo. Abre a lista de cobrancas.', 0.01, 0),
	...
	('maleta_maquiagem', 'Maleta de Maquiagem', 999, 1, 'item_standard', 1, 1730, 1, '{}', 'Maleta com pos, batons e pinceis. Abre o menu de maquiagem de qualquer lugar e nao se gasta.', 0.01, 0),
	('mangueira', 'Mangueira', 999, 1, 'item_standard', 1, 1736, 1, '{}', 'Rolo de mangueira de lona. Conecta na bomba dagua e rega a plantacao sem precisar de balde.', 0.01, 0),
	('manoplas', 'Manoplas', 100, 1, 'item_standard', 1, 1368, 1, '{}', 'nice item', 0.50, 0),
	('manteiga', 'Manteiga', 999, 1, 'item_standard', 1, 1793, 1, '{}', 'Manteiga.', 0.01, 0),
	...
	('mascado', 'Tabaco mascado', 100, 1, 'item_standard', 1, 1668, 1, '{}', 'Mascado', 0.50, 0),
	...
	('medico_Annesburg', 'Livro Medico Annesburg', 999, 1, 'item_standard', 1, 1794, 1, '{}', 'Livro Medico Annesburg.', 0.01, 0),
	('medico_blackwater', 'Livro Medico Blackwater', 999, 1, 'item_standard', 1, 1795, 1, '{}', 'Livro Medico Blackwater.', 0.01, 0),
	('medico_rhodes', 'Livro Medico Rhodes', 999, 1, 'item_standard', 1, 1796, 1, '{}', 'Livro Medico Rhodes.', 0.01, 0),
	('medico_saintdenis', 'Livro Medico Saint Denis', 999, 1, 'item_standard', 1, 1797, 1, '{}', 'Livro Medico Saint Denis.', 0.01, 0),
	('medico_straw', 'Livro Medico Strawberry', 999, 1, 'item_standard', 1, 1798, 1, '{}', 'Livro Medico Strawberry.', 0.01, 0),
	('medico_tumbleweed', 'Livro Medico Tumbleweed', 999, 1, 'item_standard', 1, 1799, 1, '{}', 'Livro Medico Tumbleweed.', 0.01, 0),
	...
	('mola_arma', 'Mola de Arma', 999, 1, 'item_standard', 1, 1800, 1, '{}', 'Mola de Arma.', 0.01, 0),
	...
	('moonshinestrawberry', 'Monshine de Morango', 100, 1, 'item_standard', 1, 681, 1, '{}', 'nice item', 0.50, 0),
	...
	('mooshine_sangue', 'Moonshine Sangue', 999, 1, 'item_standard', 1, 1801, 1, '{}', 'Moonshine Sangue.', 0.01, 0),
	...
	('mountainmen', 'Mountain Camp Set', 20, 1, 'item_standard', 1, 1853, 1, '{}', 'nice item', 0.25, 0),
	...
	('nata', 'Nata', 999, 1, 'item_standard', 1, 1802, 1, '{}', 'Nata.', 0.01, 0),
	...
	('nativedecor', 'Native Decor Set', 20, 1, 'item_standard', 1, 1831, 1, '{}', 'nice item', 0.25, 0),
	...
	('nativeskull', 'Decoração Nativa 1', 100, 1, 'item_standard', 1, 944, 1, '{}', 'nice item', 1.50, 0),
	...
	('naturalwagon', 'Naturalists Wagon Set', 20, 1, 'item_standard', 1, 1850, 1, '{}', 'nice item', 0.25, 0),
	...
	('oil_arma', 'oil_arma', 100, 1, 'item_standard', 1, 1729, 1, '{}', 'nice item', 0.25, 0),
	...
	('olho_pantera', 'Olho de Pantera', 999, 1, 'item_standard', 1, 1803, 1, '{}', 'Olho de Pantera.', 0.01, 0),
	('opio', 'Opio', 999, 1, 'item_standard', 1, 1804, 1, '{}', 'Opio.', 0.01, 0),
	('oregano', 'Orégano', 100, 1, 'item_standard', 1, 583, 1, '{}', 'nice item', 0.50, 0),
	('orquidea_fantasma', 'Orquidea Fantasma', 999, 1, 'item_standard', 1, 1805, 1, '{}', 'Orquidea Fantasma.', 0.01, 0),
	...
	('padaria_saintdenis', 'Livro Padaria Saint Denis', 999, 1, 'item_standard', 1, 1806, 1, '{}', 'Livro Padaria Saint Denis.', 0.01, 0),
	('palha_milho', 'Palha de Milho', 999, 1, 'item_standard', 1, 1807, 1, '{}', 'Palha de Milho.', 0.01, 0),
	('panela', 'Panela', 25, 1, 'item_standard', 1, 889, 1, '{}', 'nice item', 2.00, 0),
	('pano_arma', 'Pano de armas', 100, 1, 'item_standard', 1, 1728, 1, '{}', 'nice item', 0.25, 0),
	...
	('pipe', 'Cachimbo', 100, 1, 'item_standard', 1, 1713, 1, '{}', 'nice item', 0.25, 0),
	('pipecopper', 'Tubo de cobre', 100, 1, 'item_standard', 1, 661, 1, '{}', 'nice item', 0.50, 0),
	('pipe_smoker', 'Cachimbo', 100, 1, 'item_standard', 1, 1664, 1, '{}', 'Para fumar com classe', 0.50, 0),
	('planador_tabua', 'Planador de Tabuas', 999, 1, 'item_standard', 1, 1737, 1, '{}', 'Plaina de madeira com lamina de aco. Alisa tabuas brutas na bancada da madeireira.', 0.01, 0),
	('poisonItem', 'poisonItem', 100, 1, 'item_standard', 1, 1461, 1, '{}', 'nice item', 0.10, 0),
	('pokerset', 'Poker Table Set', 20, 1, 'item_standard', 1, 1823, 1, '{}', 'nice item', 0.25, 0),
	...
	('portal', 'Portal', 999, 1, 'item_standard', 1, 1918, 1, '{}', 'Reliquia que abre um portal de fogo.', 0.01, 0),
	('poster', 'Posters', 100, 1, 'item_standard', 1, 841, 1, '{}', 'nice item', 0.50, 0),
	('poste_cavalo_prop', 'Poste Amarração', 100, 1, 'item_standard', 1, 761, 1, '{}', 'nice item', 6.00, 0),
	('pot', 'Pote de Destilaria', 100, 1, 'item_standard', 1, 662, 1, '{}', 'nice item', 0.50, 0),
	('pota', 'House Pot', 20, 1, 'item_standard', 1, 1870, 1, '{}', 'nice item', 0.25, 0),
	...
	('potion10', 'Poção do Rato', 100, 1, 'item_standard', 1, 1712, 1, '{}', 'nice item', 0.25, 0),
	...
	('racaogalinha', 'Ração de Galinha', 100, 1, 'item_standard', 1, 1296, 1, '{}', 'nice item', 0.25, 0),
	('racaoovelha', 'Ração de Ovelha', 100, 1, 'item_standard', 1, 1295, 1, '{}', 'nice item', 0.25, 0),
	('racaoporco', 'Ração de Porco', 100, 1, 'item_standard', 1, 1294, 1, '{}', 'nice item', 0.25, 0),
	('racaovaca', 'Ração de Vaca', 100, 1, 'item_standard', 1, 1293, 1, '{}', 'nice item', 0.25, 0),
	...
	('raspadinha_bronze', 'Raspadinha Bronze', 999, 1, 'item_standard', 1, 1742, 1, '{}', 'Bilhete de raspar mais barato. Premios pequenos, mas pode sair outro bilhete.', 0.01, 0),
	('raspadinha_ouro', 'Raspadinha Ouro', 999, 1, 'item_standard', 1, 1744, 1, '{}', 'Bilhete de raspar mais caro. O unico que paga premio alto.', 0.01, 0),
	('raspadinha_prata', 'Raspadinha Prata', 999, 1, 'item_standard', 1, 1743, 1, '{}', 'Bilhete de raspar intermediario. Premios melhores que o bronze.', 0.01, 0),
	...
	('reliquia_circulo_fogo', 'Reliquia do Circulo de Fogo', 999, 1, 'item_standard', 1, 1808, 1, '{}', 'Reliquia do Circulo de Fogo.', 0.01, 0),
	('reliquia_esmaga', 'Reliquia do Esmagamento', 999, 1, 'item_standard', 1, 1809, 1, '{}', 'Reliquia do Esmagamento.', 0.01, 0),
	('reliquia_freeze', 'Reliquia do Congelamento', 999, 1, 'item_standard', 1, 1810, 1, '{}', 'Reliquia do Congelamento.', 0.01, 0),
	('reliquia_gelo', 'Reliquia de Gelo', 999, 1, 'item_standard', 1, 1811, 1, '{}', 'Reliquia de Gelo.', 0.01, 0),
	('reliquia_morte_lenta', 'Reliquia da Morte Lenta', 999, 1, 'item_standard', 1, 1812, 1, '{}', 'Reliquia da Morte Lenta.', 0.01, 0),
	('reliquia_soco', 'Reliquia do Soco', 999, 1, 'item_standard', 1, 1813, 1, '{}', 'Reliquia do Soco.', 0.01, 0),
	('reliquia_telecineze', 'Reliquia da Telecinese', 999, 1, 'item_standard', 1, 1814, 1, '{}', 'Reliquia da Telecinese.', 0.01, 0),
	...
	('robberyplanning', 'Robbery Planning Set', 20, 1, 'item_standard', 1, 1849, 1, '{}', 'nice item', 0.25, 0),
	('rollingpaper', 'Ceda', 100, 1, 'item_standard', 1, 1716, 1, '{}', 'nice item', 0.25, 0),
	...
	('saloon_armadillo', 'Livro Saloon Armadillo', 999, 1, 'item_standard', 1, 1815, 1, '{}', 'Livro Saloon Armadillo.', 0.01, 0),
	...
	('sementeluppolo', 'Semente de Lupulo', 999, 1, 'item_standard', 1, 1914, 1, '{}', 'Semente de lupulo. Plante para colher.', 0.01, 0),
	('sementemaca', 'semente maca', 100, 1, 'item_standard', 1, 560, 1, '{}', 'nice item', 0.50, 0),
	('sementemaconha', 'Semente de Maconha', 999, 1, 'item_standard', 1, 1916, 1, '{}', 'Semente de maconha. Plante para colher.', 0.01, 0),
	...
	('sementemorango', 'Semente de Morango', 999, 1, 'item_standard', 1, 1915, 1, '{}', 'Semente de morango. Plante para colher.', 0.01, 0),
	...
	('sobrenatural', 'Livro Sobrenatural', 999, 1, 'item_standard', 1, 1816, 1, '{}', 'Livro Sobrenatural.', 0.01, 0),
	...
	('standingtorch', 'Stading Torch', 20, 1, 'item_standard', 1, 1857, 1, '{}', 'nice item', 0.25, 0),
	...
	('tabacodemascar', 'Tabaco de Mascar', 100, 1, 'item_standard', 1, 1669, 1, '{}', 'Tabaco para mascar', 0.50, 0),
	...
	('tecido', 'Trapo', 999, 1, 'item_standard', 1, 1740, 1, '{}', 'Retalho de pano sujo catado do lixo. Ainda serve pra remendar alguma coisa.', 0.01, 0),
	('tele', 'Telecinese', 999, 1, 'item_standard', 1, 1919, 1, '{}', 'Reliquia que concede telecinese.', 0.01, 0),
	...
	('tobaccopipe', 'Tabaco seco', 100, 1, 'item_standard', 1, 1665, 1, '{}', 'Tabaco de qualidade', 0.50, 0),
	...
	('tribo_02', 'Livro Tribo 02', 999, 1, 'item_standard', 1, 1817, 1, '{}', 'Livro Tribo 02.', 0.01, 0),
	('trigo', 'Trigo', 100, 1, 'item_standard', 1, 618, 1, '{}', 'nice item', 0.50, 0),
	('undertaker1', 'Coffin', 20, 1, 'item_standard', 1, 1854, 1, '{}', 'nice item', 0.25, 0),
	('undertaker2', 'Flower Coffin', 20, 1, 'item_standard', 1, 1855, 1, '{}', 'nice item', 0.25, 0),
	...
	('vacina_animal', 'Vacina Veterinaria', 999, 1, 'item_standard', 1, 1912, 1, '{}', 'Seringa com vacina para o gado do rancho.', 0.01, 0),
	...
	('veterinario_esmerald', 'Livro Veterinario Emerald', 999, 1, 'item_standard', 1, 1818, 1, '{}', 'Livro Veterinario Emerald.', 0.01, 0),
	...
	('waterbarrel', 'Water Barrel', 20, 1, 'item_standard', 1, 1832, 1, '{}', 'nice item', 0.25, 0),
	('water_pump', 'Water Pump', 20, 1, 'item_standard', 1, 1871, 1, '{}', 'nice item', 0.25, 0),
	...
	('weedpack', 'Flor de Maconha', 100, 1, 'item_standard', 1, 1674, 1, '{}', 'Flor natural', 0.50, 0),
	('whisky', 'Whisky', 999, 1, 'item_standard', 1, 1819, 1, '{}', 'Whisky.', 0.01, 0),
	...
	('xarope_tosse', 'Xarope para Tosse', 999, 1, 'item_standard', 1, 1820, 1, '{}', 'Xarope para Tosse.', 0.01, 0),
...
CREATE TABLE IF NOT EXISTS `jail` (
  ...
  `characterid` varchar(64) NOT NULL DEFAULT '0',
...
INSERT IGNORE INTO `mdg_barber` (`id`, `identifier`, `charid`, `ownername`, `money`, `name`, `price`, `blipsprite`, `blipmodif`) VALUES
	(1, '0', 0, '', 4, 'Blackwater Barber', 100000, -2090472724, 0),
	(2, '0', 0, '', 3, 'Valentine Barber', 100000, -2090472724, 0),
	(3, '0', 0, '', 4, 'Saint Denis Barber', 100000, -2090472724, 0);

-- Copiando estrutura para tabela mdg_ultimate.mdg_barber_shops
CREATE TABLE IF NOT EXISTS `mdg_barber_shops` (
  `id` int(11) NOT NULL,
  `charkey` varchar(60) NOT NULL DEFAULT '0',
  `ownername` varchar(80) NOT NULL DEFAULT '',
  `money` int(11) NOT NULL DEFAULT 0,
  `name` varchar(80) NOT NULL,
  `price` int(11) NOT NULL DEFAULT 0,
  `blipsprite` bigint(20) NOT NULL DEFAULT 0,
  `blipmodif` bigint(20) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Copiando dados para a tabela mdg_ultimate.mdg_barber_shops: ~3 rows (aproximadamente)
INSERT IGNORE INTO `mdg_barber_shops` (`id`, `charkey`, `ownername`, `money`, `name`, `price`, `blipsprite`, `blipmodif`) VALUES
	(1, '0', '', 0, 'Blackwater', 2500, -2090472724, 0),
	(2, '0', '', 0, 'Valentine', 2000, -2090472724, 0),
	(3, '0', '', 0, 'Saint Denis', 3000, -2090472724, 0);
...
-- Copiando estrutura para tabela mdg_ultimate.mdg_gift_diary
CREATE TABLE IF NOT EXISTS `mdg_gift_diary` (
...
-- Copiando dados para a tabela mdg_ultimate.mdg_gift_diary: ~0 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `mdg_horses` (
  ...
  `wild_expires_at` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `mdg_stable_bought` (
  ...
  `saddlebag_maxWeight` int(11) DEFAULT NULL,
  `saddlebag_maxSlots` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `identifier` (`identifier`,`charid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
-- Copiando estrutura para tabela mdg_ultimate.mdg_vip_logs
CREATE TABLE IF NOT EXISTS `mdg_vip_logs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `charid` int(11) DEFAULT NULL,
  `identifier` varchar(120) DEFAULT NULL,
  `vip` varchar(120) DEFAULT NULL,
...
-- Copiando dados para a tabela mdg_ultimate.mdg_vip_logs: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela mdg_ultimate.mdg_vip_pending
CREATE TABLE IF NOT EXISTS `mdg_vip_pending` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `identifier` varchar(120) DEFAULT NULL,
  `vip` varchar(120) DEFAULT NULL,
...
-- Copiando dados para a tabela mdg_ultimate.mdg_vip_pending: ~0 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `mdg_wagons` (
  ...
  `isOut` tinyint(1) NOT NULL DEFAULT 0,
  `locker_maxWeight` int(11) DEFAULT NULL,
  `locker_maxSlots` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- Copiando dados para a tabela mdg_ultimate.mdg_wagons: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela mdg_ultimate.mdg_wagon_stash
CREATE TABLE IF NOT EXISTS `mdg_wagon_stash` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `charid` varchar(64) NOT NULL,
  `model` varchar(100) NOT NULL,
  `items` longtext DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `charid_model` (`charid`,`model`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Copiando dados para a tabela mdg_ultimate.mdg_wagon_stash: ~0 rows (aproximadamente)
...
-- Copiando estrutura para tabela mdg_ultimate.outfitter
...
-- Copiando dados para a tabela mdg_ultimate.outfitter: ~0 rows (aproximadamente)
...
-- Copiando estrutura para tabela mdg_ultimate.player_diseases
CREATE TABLE IF NOT EXISTS `player_diseases` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `identifier` varchar(50) NOT NULL,
  `disease` varchar(50) NOT NULL,
  `infected` int(11) DEFAULT 1,
  `infected_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_disease` (`identifier`,`disease`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- Copiando dados para a tabela mdg_ultimate.player_diseases: ~0 rows (aproximadamente)
...
-- Copiando estrutura para tabela mdg_ultimate.police_handcuffs
CREATE TABLE IF NOT EXISTS `police_handcuffs` (
  `charid` varchar(64) NOT NULL,
  `handcuffed` tinyint(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`charid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- Copiando dados para a tabela mdg_ultimate.police_handcuffs: ~0 rows (aproximadamente)
...
-- Copiando estrutura para tabela mdg_ultimate.prisao_historico
CREATE TABLE IF NOT EXISTS `prisao_historico` (
  ...
  `oficial` varchar(100) DEFAULT NULL,
  `jaillocation` varchar(64) DEFAULT NULL,
  `data_prisao` varchar(64) DEFAULT NULL,
  `status` varchar(10) DEFAULT 'preso',
  `data_soltura` varchar(64) DEFAULT NULL,
  `motivo_soltura` varchar(100) DEFAULT NULL,
  `oficial_soltura` varchar(100) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`caso`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- Copiando dados para a tabela mdg_ultimate.prisao_historico: ~0 rows (aproximadamente)
...
-- Copiando estrutura para tabela mdg_ultimate.ranch_meta
CREATE TABLE IF NOT EXISTS `ranch_meta` (
  `k` varchar(50) NOT NULL,
  `v` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`k`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- Copiando dados para a tabela mdg_ultimate.ranch_meta: ~1 rows (aproximadamente)
INSERT IGNORE INTO `ranch_meta` (`k`, `v`) VALUES
	('tax_init', '1');
...
-- Copiando estrutura para tabela mdg_ultimate.roubo_cooldowns
CREATE TABLE IF NOT EXISTS `roubo_cooldowns` (
  `local_id` int(11) NOT NULL,
  `cooldown_end` bigint(20) NOT NULL,
  PRIMARY KEY (`local_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- Copiando dados para a tabela mdg_ultimate.roubo_cooldowns: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela mdg_ultimate.society: ~53 rows (aproximadamente)
...
-- Copiando dados para a tabela mdg_ultimate.society_ledger: ~70 rows (aproximadamente)
...
-- Copiando dados para a tabela mdg_ultimate.users: ~1 rows (aproximadamente)
INSERT IGNORE INTO `users` (`identifier`, `group`, `warnings`, `banned`, `banneduntil`, `char`, `max_jobs`) VALUES
	('steam:1100001002d7683', 'admin', 0, 0, 0, 1, 1);

-- Copiando estrutura para tabela mdg_ultimate.vampires
CREATE TABLE IF NOT EXISTS `vampires` (
  `identifier` varchar(50) NOT NULL,
  `charid` int(11) NOT NULL,
  `is_vampire` tinyint(1) DEFAULT 0,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`identifier`,`charid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- Copiando dados para a tabela mdg_ultimate.vampires: ~0 rows (aproximadamente)
...
-- Copiando estrutura para tabela mdg_ultimate.vlt_clan_members
CREATE TABLE IF NOT EXISTS `vlt_clan_members` (
  `charidentifier` varchar(50) NOT NULL,
  `clan` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`charidentifier`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Copiando dados para a tabela mdg_ultimate.vlt_clan_members: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela mdg_ultimate.vlt_collect_quests
CREATE TABLE IF NOT EXISTS `vlt_collect_quests` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `identifier` varchar(50) NOT NULL,
  `charid` int(11) NOT NULL,
  `questtype` int(2) NOT NULL,
...
-- Copiando dados para a tabela mdg_ultimate.vlt_collect_quests: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela mdg_ultimate.vlt_craft_levels
CREATE TABLE IF NOT EXISTS `vlt_craft_levels` (
  `charid` varchar(50) NOT NULL,
...
-- Copiando dados para a tabela mdg_ultimate.vlt_craft_levels: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela mdg_ultimate.vlt_domination
CREATE TABLE IF NOT EXISTS `vlt_domination` (
  `area_name` varchar(50) NOT NULL,
  `owner_charid` varchar(64) NOT NULL,
  `owner_name` varchar(100) DEFAULT NULL,
  `captured_at` bigint(20) DEFAULT 0,
  PRIMARY KEY (`area_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Copiando dados para a tabela mdg_ultimate.vlt_domination: ~0 rows (aproximadamente)
...
-- Copiando estrutura para tabela mdg_ultimate.vlt_houserobbery
CREATE TABLE IF NOT EXISTS `vlt_houserobbery` (
  `charid` int(11) NOT NULL,
  `level` int(11) DEFAULT 1,
  `xp` int(11) DEFAULT 0,
...
-- Copiando dados para a tabela mdg_ultimate.vlt_houserobbery: ~0 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `vlt_madame_nazar` (
  `charid` varchar(60) NOT NULL DEFAULT '0',
  `identifier` varchar(100) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vlt_ped_menu` (
  ...
  `pedDate` timestamp NULL DEFAULT NULL,
  `pedUseOutfit` tinyint(1) DEFAULT 0,
  `charkey` varchar(60) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
-- Copiando estrutura para tabela mdg_ultimate.vlt_player_ranch
CREATE TABLE IF NOT EXISTS `vlt_player_ranch` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `identifier` varchar(50) DEFAULT NULL,
  `charidentifier` int(11) DEFAULT NULL,
  `name` longtext DEFAULT NULL,
  ...
  `managers` longtext DEFAULT '[]',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Copiando dados para a tabela mdg_ultimate.vlt_player_ranch: ~0 rows (aproximadamente)
...
-- Copiando estrutura para tabela mdg_ultimate.weapon_portes
CREATE TABLE IF NOT EXISTS `weapon_portes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `identifier` varchar(50) NOT NULL,
  `charidentifier` int(11) NOT NULL,
...
-- Copiando dados para a tabela mdg_ultimate.weapon_portes: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela mdg_ultimate.weapon_presets
CREATE TABLE IF NOT EXISTS `weapon_presets` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `identifier` varchar(50) NOT NULL,
  `charidentifier` int(11) NOT NULL,
  `weapon_hash` bigint(20) NOT NULL,
  `preset_name` varchar(100) NOT NULL,
  `components` longtext NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `identifier_charidentifier` (`identifier`,`charidentifier`),
  KEY `weapon_hash` (`weapon_hash`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Copiando dados para a tabela mdg_ultimate.weapon_presets: ~0 rows (aproximadamente)
