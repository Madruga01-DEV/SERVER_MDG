...
-- Copiando estrutura do banco de dados para modelo_m1
CREATE DATABASE IF NOT EXISTS `modelo_m1` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `modelo_m1`;

-- Copiando estrutura para tabela modelo_m1.bank_users
...
-- Copiando dados para a tabela modelo_m1.bank_users: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.bills
...
-- Copiando dados para a tabela modelo_m1.bills: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.characters
...
-- Copiando dados para a tabela modelo_m1.characters: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.character_inventories
...
-- Copiando dados para a tabela modelo_m1.character_inventories: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.clothes_bought
...
-- Copiando dados para a tabela modelo_m1.clothes_bought: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.container
...
-- Copiando dados para a tabela modelo_m1.container: ~70 rows (aproximadamente)
...
-- Copiando estrutura para tabela modelo_m1.doors
...
-- Copiando dados para a tabela modelo_m1.doors: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.farming
...
-- Copiando dados para a tabela modelo_m1.farming: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.herbalists
...
-- Copiando dados para a tabela modelo_m1.herbalists: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.horses
...
-- Copiando dados para a tabela modelo_m1.horses: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.horsesstore
...
-- Copiando dados para a tabela modelo_m1.horsesstore: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.horsestrainers
...
-- Copiando dados para a tabela modelo_m1.horsestrainers: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.horses_breeding
...
-- Copiando dados para a tabela modelo_m1.horses_breeding: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.housing
...
-- Copiando dados para a tabela modelo_m1.housing: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.items
...
) ENGINE=InnoDB AUTO_INCREMENT=1663 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;

-- Copiando dados para a tabela modelo_m1.items: ~1.044 rows (aproximadamente)
INSERT IGNORE INTO `items` (`item`, `label`, `limit`, `can_remove`, `type`, `usable`, `id`, `groupId`, `metadata`, `desc`, `weight`, `degradation`) VALUES
	...
	('apito', 'Apito de Passaros', 100, 1, 'item_standard', 1, 1427, 1, '{}', 'nice item', 0.25, 0),
	...
	('dinheiro_sujo', 'Dinheiro Sujo', 1000000, 1, 'item_standard', 1, 880, 1, '{}', 'nice item', 0.50, 0),
...
-- Copiando estrutura para tabela modelo_m1.items_crafted
...
-- Copiando dados para a tabela modelo_m1.items_crafted: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.item_group
...
-- Copiando dados para a tabela modelo_m1.item_group: ~11 rows (aproximadamente)
...
-- Copiando estrutura para tabela modelo_m1.jail
...
-- Copiando dados para a tabela modelo_m1.jail: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.loadout
...
-- Copiando dados para a tabela modelo_m1.loadout: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.mailbox_mails
...
-- Copiando dados para a tabela modelo_m1.mailbox_mails: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.mdg_clothes_state
...
-- Copiando dados para a tabela modelo_m1.mdg_clothes_state: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.mdg_horses
...
-- Copiando dados para a tabela modelo_m1.mdg_horses: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.mdg_horses_stats
...
-- Copiando dados para a tabela modelo_m1.mdg_horses_stats: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.mdg_matabolism_v2
...
-- Copiando dados para a tabela modelo_m1.mdg_matabolism_v2: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.mdg_outfits
...
-- Copiando dados para a tabela modelo_m1.mdg_outfits: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.mdg_stable_bought
...
-- Copiando dados para a tabela modelo_m1.mdg_stable_bought: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.mdg_stable_color
...
-- Copiando dados para a tabela modelo_m1.mdg_stable_color: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.mdg_vip
...
-- Copiando dados para a tabela modelo_m1.mdg_vip: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.mdg_wagons
...
-- Copiando dados para a tabela modelo_m1.mdg_wagons: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.outfits
...
-- Copiando dados para a tabela modelo_m1.outfits: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.pets
...
-- Copiando dados para a tabela modelo_m1.pets: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.playershops
...
-- Copiando dados para a tabela modelo_m1.playershops: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.playershops2
...
-- Copiando dados para a tabela modelo_m1.playershops2: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.ranch
...
-- Copiando dados para a tabela modelo_m1.ranch: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.real_logic_horses
CREATE TABLE IF NOT EXISTS `real_logic_horses` (
  `update_time` int(11) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Copiando dados para a tabela modelo_m1.real_logic_horses: ~0 rows (aproximadamente)
INSERT IGNORE INTO `real_logic_horses` (`update_time`) VALUES
	(0);

-- Copiando estrutura para tabela modelo_m1.real_logic_pets
CREATE TABLE IF NOT EXISTS `real_logic_pets` (
  `update_time` int(11) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Copiando dados para a tabela modelo_m1.real_logic_pets: ~2 rows (aproximadamente)
INSERT IGNORE INTO `real_logic_pets` (`update_time`) VALUES
	(0),
	(0);

-- Copiando estrutura para tabela modelo_m1.real_logic_ranch
CREATE TABLE IF NOT EXISTS `real_logic_ranch` (
  `update_time` int(11) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Copiando dados para a tabela modelo_m1.real_logic_ranch: ~0 rows (aproximadamente)
INSERT IGNORE INTO `real_logic_ranch` (`update_time`) VALUES
	(0);

-- Copiando estrutura para tabela modelo_m1.rooms
...
-- Copiando dados para a tabela modelo_m1.rooms: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.society
...
-- Copiando dados para a tabela modelo_m1.society: ~53 rows (aproximadamente)
...
-- Copiando estrutura para tabela modelo_m1.society_ledger
CREATE TABLE IF NOT EXISTS `society_ledger` (
  `job` longtext DEFAULT NULL,
  `ledger` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Copiando dados para a tabela modelo_m1.society_ledger: ~70 rows (aproximadamente)
...
-- Copiando estrutura para tabela modelo_m1.stables
...
-- Copiando dados para a tabela modelo_m1.stables: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.users
...
-- Copiando dados para a tabela modelo_m1.users: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.vlt_bank
...
-- Copiando dados para a tabela modelo_m1.vlt_bank: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.vlt_barber_system
...
-- Copiando dados para a tabela modelo_m1.vlt_boats_system: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.vlt_identity
...
-- Copiando dados para a tabela modelo_m1.vlt_identity: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.vlt_madame_nazar
...
-- Copiando dados para a tabela modelo_m1.vlt_madame_nazar: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.vlt_player_ranch
...
-- Copiando dados para a tabela modelo_m1.vlt_player_ranch: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.wagons
...
-- Copiando dados para a tabela modelo_m1.wagons: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela modelo_m1.whitelist
...
-- Copiando dados para a tabela modelo_m1.whitelist: ~0 rows (aproximadamente)

-- Copiando estrutura para trigger modelo_m1.add_mdg_horses_stats
