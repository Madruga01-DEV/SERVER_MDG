...
Config = {
	...
	-- FIRST JOIN
	startItems          = {
		consumable_coffee = 2, --ITEMS SAME NAME AS IN DATABASE consumable_asian_soda_lime
		consumable_asian_soda_lime = 2,
		consumable_chickenpie = 2,
		consumable_steakpie = 2,
		   --AMMO SAME NAME AS I NTHE DATABASE
	},
