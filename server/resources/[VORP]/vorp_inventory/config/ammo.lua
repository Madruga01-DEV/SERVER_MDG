...
SharedData.MaxAmmo    = {
    ...
    AMMO_PISTOL_EXPRESS_EXPLOSIVE = 20,
    AMMO_PISTOL_HIGH_VELOCITY = 20,
    AMMO_PISTOL_SPLIT_POINT = 20,
    AMMO_REPEATER = 20,
    AMMO_REPEATER_EXPRESS = 20,
    AMMO_REPEATER_EXPRESS_EXPLOSIVE = 20,
    AMMO_REPEATER_HIGH_VELOCITY = 20,
    AMMO_REPEATER_SPLIT_POINT = 20,
    AMMO_REVOLVER = 20,
    AMMO_REVOLVER_EXPRESS = 20,
    AMMO_REVOLVER_EXPRESS_EXPLOSIVE = 20,
    AMMO_REVOLVER_HIGH_VELOCITY = 20,
    AMMO_REVOLVER_SPLIT_POINT = 20,
    AMMO_RIFLE = 20,
    AMMO_RIFLE_ELEPHANT = 20,
    AMMO_RIFLE_EXPRESS = 20,
    AMMO_RIFLE_EXPRESS_EXPLOSIVE = 20,
    AMMO_RIFLE_HIGH_VELOCITY = 20,
    AMMO_RIFLE_SPLIT_POINT = 20,
    AMMO_22 = 20,
    AMMO_22_TRANQUILIZER = 20,
    AMMO_SHOTGUN = 20,
    AMMO_SHOTGUN_BUCKSHOT_INCENDIARY = 20,
    AMMO_SHOTGUN_SLUG_EXPLOSIVE = 20,
    AMMO_SHOTGUN_SLUG = 20,
    AMMO_ARROW = 10,
