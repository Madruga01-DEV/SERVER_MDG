...
Config = {
    ...
    initInvCapacity       = 65.0,          -- Initial number of character inventory weight for new players. for old characters you must change in the database if you dont ave a new server
    ...
    initJobLabel          = "desempregado",  -- Default job label for new players. Recommended not to change.
    ...
    CommandOnOffPVP       = 'çx',         -- Command to toggle PVP status, requires PVPToggle to be true.
