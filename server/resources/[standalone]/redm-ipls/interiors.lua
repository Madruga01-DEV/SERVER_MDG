	...
	if IsValidInterior(interior) then
		if IsInteriorEntitySetActive(interior, sets[1]) then
			...
			for _, set in ipairs(sets) do
				ActivateInteriorEntitySet(interior, set, 0)
			end
		end
	end
end
...
Citizen.CreateThread(function()
	while not isLoaded do
		...
		ActivateInteriorEntitySets(50690, "Beechers", {
			...
			--"bee_01_masterBR_bed01_unmade",
			--"bee_01_masterBR_bed03",
			--"bee_01_masterBR_bed03_unmade",
			--"bee_01_masterBR_bed_Abigail3",
			--"bee_squirrel_inFireplaceMasterRm",
			--"bee_squirrel_inFootlockerAttic",
			--"bee_squirrel_inFootlockerMasterRm",
			--"bee_squirrel_onLivingRmShelf",
...
RequestImap(1271713904)  --farm im norden stall
RequestImap(1423681694)  --farm im norden stall
RequestImap(1293624693)
RequestImap(-1305406402) --Schield
RequestImap(1983816160)
RequestImap(-602816690)
RequestImap(636278554)
RequestImap(-285245562) --schmiede
RequestImap(1031662866) --tore
...
RequestImap(-313259746) --camp fluss
RequestImap(-367168072) --camp fluss
...
RequestImap(-886310806) --Rodes Bank
...
RequestImap(834697453)
RequestImap(1253364275)
RequestImap(-1310914542)
...
RequestImap(-166639526) --camp fluss
...
RequestImap(1812712970)
RequestImap(787163418)
...
-- RequestImap(-490818122) --Rodes wagon
...
RequestImap(-1276109918) --Rodes neues Haus
RequestImap(-1386423483) --Rodes neues Haus
-- RequestImap(-1331593143)
RequestImap(-1405375965) --Rodes neues Haus
...
RequestImap(-1892843345) --guv feld
...
RequestImap(366542865) --guv feld
RequestImap(241205019) --guv feld
...
RequestImap(-1452136643) --guv feld
RequestImap(-744260705)  --guv feld
-- RequestImap(1424293412)
RequestImap(1060557512)  --guv feld
RequestImap(-362403544)  --guv feld
RequestImap(-592147003)  --guv feld
RequestImap(352816221)   --guv feld
RequestImap(1128622296)  --guv feld
RequestImap(979982112)   --Baumwollfeld
